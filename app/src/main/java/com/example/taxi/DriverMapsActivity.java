...
public class DriverMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void updateLocationUI() {
        ...
        if (currentLocation != null) {
            ...
            String driverUserID = currentUser.getUid();
            DatabaseReference driversGoeFire = FirebaseDatabase.getInstance().getReference()
                    .child("driversGeoFire");
            DatabaseReference drivers = FirebaseDatabase.getInstance().getReference()
                    .child("drivers");

            GeoFire geoFire = new GeoFire(driversGoeFire);
            ...
            showSnackBar(
                    ...
                    new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            ActivityCompat
                                    .requestPermissions(DriverMapsActivity.this,
                                            new String[]{
                                                    Manifest.permission.ACCESS_FINE_LOCATION
                                            },
