...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private Button signOutButton, settingsButton, searchDriverButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchDriverButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                searchDriverButton.setText("Searching your taxi ...");

                searchingNearestTaxi();
            }
        });
    ...
    private void searchingNearestTaxi() {
    ...
    private void getNearestDriverLocation() {
        ...
        searchDriverButton.setText("Getting your driver location...");
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    if (driverMarker != null) {
                        ...
                        float distanceToDriver = driverLocation
                                .distanceTo(currentLocation);

                        searchDriverButton.setText("Distance to driver: "
                                + distanceToDriver);
